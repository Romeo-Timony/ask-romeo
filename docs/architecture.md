...
6. `ASKROMEO_RAG_STORE=memory` keeps chunks in the running Node process. `ASKROMEO_RAG_STORE=postgres` stores chunks and vectors in Postgres using pgvector.
