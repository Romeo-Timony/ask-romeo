...
export const questionSurfacesRu = [
  ...
  entry('home.ai.workflow', 'faq.ai_usage.default', 'home', 4, 'AI в работе', 'Как Romeo применяет AI в процессах PM и QA?', 'tooling_workflow_steps', true),
  ...
  entry('project.askoosu.rag', 'faq.project.askoosu.rag.default', 'project.askoosu', 2, 'RAG-архитектура', 'Как устроена RAG-архитектура и поиск в Ask Romeo?', 'architecture_steps_diagram', false, 'detailed'),
  ...
  entry('project.askoosu.deployment', 'faq.project.askoosu.deployment.default', 'project.askoosu', 4, 'Деплой', 'Как развёрнут и поддерживается проект Ask Romeo?', 'deployment_stack_flow'),
  entry('project.askoosu.before_after', 'faq.project.portfoliooh_vs_askoosu.default', 'project.askoosu', 5, 'До и после', 'В чём преимущество Ask Romeo перед классическим портфолио?', 'comparison_grid'),
