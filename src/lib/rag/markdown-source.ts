...
const LOCAL_MARKDOWN_DOCUMENTS: LocalMarkdownDocument[] = [
  {
    path: 'docs/rag/romeo-past-work-experience-ru.md',
    slug: 'romeo-past-work-experience-ru',
    language: 'ru',
    author: 'gpt',
  ...
  {
    path: 'docs/rag/romeo-past-work-experience-en.md',
    slug: 'romeo-past-work-experience-en',
    language: 'en',
    author: 'gpt',
  ...
  {
    path: 'docs/rag/romeo-answer-guidance-en.md',
    slug: 'romeo-answer-guidance-en',
    language: 'en',
    author: 'gpt',
