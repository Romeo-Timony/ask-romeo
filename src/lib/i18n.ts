...
export const uiText = {
  ru: {
    ...
    finishAndBackHome: 'Вернуться на главную',
    aboutMe: 'О себе',
    projects: 'Проекты',
    ...
    resume: 'Резюме',
    resumeQa: 'Резюме QA',
    resumePm: 'Резюме Project Manager',
    download: 'Скачать',
  ...
  en: {
    ...
    finishAndBackHome: 'Back to home',
    aboutMe: 'About',
    projects: 'Projects',
    ...
    resume: 'Resume',
    resumeQa: 'QA Resume',
    resumePm: 'Project Manager Resume',
    download: 'Download',
