    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="space-y flex flex-col">
          ...
          >
            {['QA', 'Prompt Engineering', 'RAG', 'OpenAI', 'Portfolio'].map(
              (tag) => (
                <span
                  key={tag}
...
function VideoVisitPlaceholder() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-gradient-to-b from-slate-50 to-slate-100 p-6 text-center dark:from-white/[0.06] dark:to-transparent">
      <div className="flex h-16 w-16 items-center justify-center rounded-full border text-lg font-semibold">
        RT
      </div>
      <p className="text-sm font-semibold">Video visit card</p>
